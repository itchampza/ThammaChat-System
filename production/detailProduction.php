...
<head>
    ...
    <title>TamMachat Dashboard</title>
    ...
    <div class="page-container">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                     <!-- ดู -->
                                    <li><a href="fetchProduction.php">แสดงข้อมูลการผลิต2</a></li>
                                     <!-- เพิ่ม -->
                    ...
                    <div class="col-xl-12 col-lg-12 mt-5 mb-5">
                      <form action="" method="post">
                        <div class="card">
                                    ...
                                    <span>
                                      <div class="row">
                                          <div class="col-xl-5 col-lg-3 " >
                                            <label for="example-text-input" class="col-form-label">บรรจุภัณฑ์</label>
                                          </div>
                                          <div class="col-xl-7 col-lg-3 " >
                                            <div class="form-group">
                                                <input class="form-control" type="text" value="ขวดใหญ่" id="example-text-input">
                                            </div>
                                          </div>
                                      </div>
                                    </span>
                                ...
                                <div class="row">
                                  <div class="col-xl-4 col-lg-3 " >
                                    ...
                                    <div class="col-xl-4 col-lg-6 ">
                                      ...
                                      <div class="row">
                                          <div class="col-xl-5 col-lg-3 " >
                                            <label for="example-text-input" class="col-form-label">จำนวน</label>
                                          </div>
                                          <div class="col-xl-7 col-lg-3 " >
                                            <div class="form-group">
                                ...
                                <div class="row">
                                  <div class="col-xl-4 col-lg-3 " >
                                    ...
                                    <div class="col-xl-4 col-lg-6 ">
                                      ...
                                      <div class="row">
                                          <div class="col-xl-5 col-lg-3 " >
                                            <label for="example-text-input" class="col-form-label">ประเภทบรรจุภัณฑ์</label>
                                          </div>
                                          <div class="col-xl-7 col-lg-3 " >
                                            <div class="form-group">
                                              <input class="form-control" type="text" value="แพ็ค" id="example-text-input">
                                            </div>
                                          </div>
                                      </div>
                                    </span>
                            ...
                            <button type="submit" class="btn btn-rounded btn-success mb-3">สั่งผลิต</button>
                        </div>
                    </div>
                  </form>
                </div>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2019. All right reserved. by Dev Champ.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>

    ...
    <div class="page-container">
            ...
            <div class="page-title-area">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="background: linear-gradient(to right, whtite 0%, white 100%);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                            <li class="mr-3"><a href="#" class="text-success"><i class="fa fa-file-text"></i></a></li>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2018. All right reserved. Template by Dev Champ</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
